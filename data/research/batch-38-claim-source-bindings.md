# Batch 38 claim-to-source bindings

Status: research draft. `Ready` means two relevant evidence routes are already in the batch map; it does not mean the claim assessment is final.

| Book | Candidate claim | Evidence route | State |
|---|---|---|---|
...
| *Public Opinion* | Citizens rely on mediated pictures and stereotypes | Agenda-setting + framing theory | Ready |
| *Public Opinion* | Media attention shapes issue importance | Agenda-setting + strategic-news meta-analyses | Ready |
