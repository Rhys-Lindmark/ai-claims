...
export async function GET(request: Request) {
  ...
  const responseHeaders = { ...headers, etag, 'x-ai-claims-correction-feed-contract': envelope.correction_feed_discovery.contract_version ?? 'none', 'x-ai-claims-deployment-attestation-contract': envelope.deployment_attestation_discovery.contract_version, 'x-ai-claims-extension-release-contract': envelope.extension_release_discovery.contract_version };
...
export async function OPTIONS() {
  return new Response(null, {
    ...
    headers: {
      ...
      'access-control-expose-headers': 'etag, x-ai-claims-correction-feed-contract, x-ai-claims-deployment-attestation-contract, x-ai-claims-extension-release-contract',
