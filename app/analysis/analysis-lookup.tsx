      ...
      <section className="mx-auto grid max-w-5xl gap-8 px-5 py-12 md:px-10 lg:grid-cols-[.8fr_1.2fr]">
        ...
        {published ? (
          ...
          <article className="border-2 border-ink border-l-[12px] border-l-coral bg-white p-6 shadow-[7px_7px_0_#1c1c1a]">
            ...
            <a className="mt-6 inline-flex border-2 border-ink bg-acid px-4 py-3 font-mono text-[9px] font-bold uppercase shadow-[3px_3px_0_#1c1c1a]" href="https://github.com/Rhys-Lindmark/ai-claims/releases/tag/extension-v0.1.6">Get the extension</a>
          </article>
        )}
      </section>
    </main>
