...
export function ResolverProbe() {
  ...
  return <section className="border-b-2 border-ink bg-[#ffd76a]">
    <div className="mx-auto grid max-w-6xl gap-7 px-5 py-10 md:px-10 lg:grid-cols-[1.05fr_.95fr]">
      <div>
        <p className="font-mono text-[9px] font-bold uppercase text-cobalt">Live resolver probe · no extension required</p>
        <h2 className="mt-3 text-4xl font-black leading-[.94] tracking-[-.045em]">PASTE A YOUTUBE URL. SEE THE GATE.</h2>
        <p className="mt-4 max-w-xl text-sm leading-relaxed text-ink/60">The browser-normalized video ID becomes one canonical entity key. Only that key reaches the public resolver; page text, title, and account data do not.</p>
        <form className="mt-6" onSubmit={submit}>
          <label className="font-mono text-[8px] font-bold uppercase" htmlFor="resolver-probe-url">YouTube URL</label>
