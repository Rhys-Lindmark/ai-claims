...
<ExtensionNorthStarDemo /><ExtensionArchitecture /><ResolverProbe /><CorrectionEventFeedDemo /><section className="mx-auto grid max-w-6xl gap-8 px-5 py-10 md:px-10 lg:grid-cols-[.8fr_1.2fr]">
