      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-5 py-10 md:px-10 lg:grid-cols-[1.2fr_.8fr] lg:items-center">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a className="inline-flex items-center gap-2 border-2 border-ink bg-ink px-4 py-3 font-mono text-[9px] font-bold uppercase text-paper shadow-[4px_4px_0_#214de8]" href="https://github.com/Rhys-Lindmark/ai-claims/tree/main/extension" target="_blank" rel="noreferrer"><PanelRightOpen className="h-4 w-4" /> Load the prototype <ExternalLink className="h-3 w-3" /></a>
