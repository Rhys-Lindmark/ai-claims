...
cp "$PROJECT_DIR/extension/lib/analysis-registry.js" "$PROJECT_DIR/extension/lib/analysis-requests.js" "$PROJECT_DIR/extension/lib/analysis-resolver.js" "$PROJECT_DIR/extension/lib/page-identity.js" "$PROJECT_DIR/extension/lib/truth-score.js" "$STAGING/package/lib/"
