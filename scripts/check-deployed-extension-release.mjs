...
assert.deepEqual(current.available_versions.map((entry) => entry.version), ['0.2.21', '0.2.20', '0.2.19', '0.2.18', '0.2.17', '0.2.16']);
...
const previousVersion = process.argv[3] ?? '0.2.20';
